...
exports.SubjectExamStrategy = void 0;
...
class SubjectExamStrategy extends base_strategy_1.BaseExamStrategy {
    async generateExam(payload) {
        if (!payload.subjectId) {
            throw new AppError_1.default(http_status_1.default.BAD_REQUEST, "Subject id is required.");
        }
...
exports.SubjectExamStrategy = SubjectExamStrategy;
//# sourceMappingURL=subject.strategy.js.map