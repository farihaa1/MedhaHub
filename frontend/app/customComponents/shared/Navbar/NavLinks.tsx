...
export const menu: MenuItem[] = [
  ...
  // ─────────────────────────────────────
  {
    ...
    items: [
      {
        title: "বিসিএস",
        description: "বিসিএসের বিগত বছরের প্রশ্ন অনুশীলন করুন।",
        icon: <Library className="size-5 shrink-0" />,
        url: "/question-banks/bcs",
      },
      {
        title: "ব্যাংক চাকরি",
        description: "ব্যাংক নিয়োগ পরীক্ষার প্রশ্নসমূহ।",
        icon: <Library className="size-5 shrink-0" />,
        url: "/question-banks/bank",
      },
      {
        title: "প্রাথমিক শিক্ষক",
        description: "প্রাথমিক শিক্ষক নিয়োগ পরীক্ষার প্রশ্ন।",
        icon: <GraduationCap className="size-5 shrink-0" />,
        url: "/question-banks/primary",
      },
    ],
  },
